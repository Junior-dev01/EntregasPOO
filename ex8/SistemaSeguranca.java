...
public class SistemaSeguranca {
    ...
    public void acessarCofre(Credencial cred) {
        ...
        if (cofreFisico.add(cred) == true) {

            System.out.println("Cofre: Acesso concedido! Bem vindo " + cred.getTitular().getNome());

        } else {

            System.out.println(
                    "ALERTA MAXIMO! Credencial " + cred.getCodigoHex() + " Bloqueada! Tentativa de clonagem detectada");
